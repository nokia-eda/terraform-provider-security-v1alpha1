---
page_title: "security-v1alpha1 Provider"
---

# security-v1alpha1 Provider

This provider is used to interact with the resources provided by the **security-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
