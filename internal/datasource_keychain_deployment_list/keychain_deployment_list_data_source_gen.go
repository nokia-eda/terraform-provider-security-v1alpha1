...
package datasource_keychain_deployment_list
...
func KeychainDeploymentListDataSourceSchema(ctx context.Context) schema.Schema {
...
type KeychainDeploymentListModel struct {
