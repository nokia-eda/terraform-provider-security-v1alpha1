...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-security/internal/resource_keychain"
	"github.com/nokia/eda/apps/terraform-provider-security/internal/tfutils"
)

const (
	create_rs_keychain = "/apps/security.eda.nokia.com/v1alpha1/namespaces/{namespace}/keychains"
	read_rs_keychain   = "/apps/security.eda.nokia.com/v1alpha1/namespaces/{namespace}/keychains/{name}"
	update_rs_keychain = "/apps/security.eda.nokia.com/v1alpha1/namespaces/{namespace}/keychains/{name}"
	delete_rs_keychain = "/apps/security.eda.nokia.com/v1alpha1/namespaces/{namespace}/keychains/{name}"
)

var (
	_ resource.Resource                = (*keychainResource)(nil)
	_ resource.ResourceWithConfigure   = (*keychainResource)(nil)
	_ resource.ResourceWithImportState = (*keychainResource)(nil)
)
...
func (r *keychainResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_keychain, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_keychain, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_keychain,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *keychainResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_keychain, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *keychainResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_keychain, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
