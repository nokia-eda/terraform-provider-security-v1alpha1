...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-security/internal/eda/utils"
...
var _ provider.Provider = (*securityProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &securityProvider{version: ver}
	}
}
...
func (p *securityProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *securityProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *securityProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "security-v1alpha1"
	resp.Version = p.version
}

func (p *securityProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewKeychainDataSource,
		NewKeychainDeploymentDataSource,
		NewKeychainDeploymentListDataSource,
		NewKeychainListDataSource,
		NewResourceListDataSource,
	}
}

func (p *securityProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewKeychainResource,
		NewKeychainDeploymentResource,
	}
}
