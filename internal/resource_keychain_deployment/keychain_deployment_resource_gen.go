...
package resource_keychain_deployment
...
func KeychainDeploymentResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^KeychainDeployment$"), ""),
				},
				Default: stringdefault.StaticString("KeychainDeployment"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the KeychainDeployment",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"keychain": schema.StringAttribute{
						...
						MarkdownDescription: "Reference to a Keychain",
					},
					"node": schema.StringAttribute{
						Required:            true,
						Description:         "Reference to a Node on which to push the BgpGroup",
						MarkdownDescription: "Reference to a Node on which to push the BgpGroup",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				MarkdownDescription: "KeychainDeploymentSpec defines the desired state of KeychainDeployment",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "KeychainDeploymentStatus defines the observed state of KeychainDeployment",
			},
		},
	}
}

type KeychainDeploymentModel struct {
